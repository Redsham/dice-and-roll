...
namespace Gameplay.Enemies.Configs
{
	...
	public class EnemyConfig : ScriptableObject
	{
		...
		[field: SerializeField] public LocalizedString DisplayName { get; private set; } = new() { TableReference = "Enemies", TableEntryReference = "enemy_name" };
		[field: SerializeField] public LocalizedString Description { get; private set; } = new() { TableReference = "Enemies", TableEntryReference = "enemy_description" };
